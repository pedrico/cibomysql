...
IngreCocinaModule.controller('CtrlIngreCocina', ['$scope', '$http', 'Upload', '$window', function ($scope, $http, Upload, $window) {
    ...
    var refresh = function () {
        ...
        $http.get('/CocinaPlatoIngre/ListaGrid/' + idplato).then(function (response) {
        ...
        //ComboBox
        $http.get('/CocinaPlatoIngre/Listaddl').then(function (response) {
    ...
    $scope.addContact = function () {
        if (angular.isUndefined($scope.ingreSeleccionado)) {
            ...
            $http.post('/CocinaPlatoIngre/' + idplato, $scope.ingreSeleccionado).then(function (response) {
    ...
    $scope.remove = function (id) {
        var idplato = getUrlParameter('plato');
        console.log(id);
        $http.delete('/CocinaPlatoIngre/' + idplato+"/Ingrediente/"+id).then(function (response) {
